...
const Million = ({ toggleMillion }) => {
  return (
    <div className="fixed w-[100vw] h-[100vh] bg-[#ffa600dd] flex justify-center items-center top-0 left-0">
      <div className="flex flex-col justify-between items-center gap-6 border-2 border-white rounded-xl p-8">
        ...
        <p className="text-3xl text-white">You won A Million Euros !</p>
        <p
